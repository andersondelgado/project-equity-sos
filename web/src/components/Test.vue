...
export default class Test extends Vue {
  ...
  public getAll() {
    const endpoint: any =
      Global.const.PRUEBA_PAGINATE + this.skip + "/" + this.limit;
  ...
  public searchAll(payload: any) {
    const endpoint: any =
      Global.const.PRUEBA_SEARCH_PAGINATE + this.skip + "/" + this.limit;
    this.columns = undefined;
    this.data = undefined;
    axios
  ...
  public edit(id: any, _rev: any) {
    const endpoint: any = Global.const.PRUEBA_EDIT + id;
  ...
  public send() {
    this.dataEdit = undefined;
    const endpoint: any = Global.const.PRUEBA_SAVE;
    axios
  ...
  public update() {
    this.dataEdit = undefined;
    const endpoint: any = Global.const.PRUEBA_UPDATE + this.ID + "/" + this.REV;
    axios
  ...
  public deletes() {
    this.dataEdit = undefined;
    const endpoint: any = Global.const.PRUEBA_DELETE + this.ID + "/" + this.REV;
    axios
      .get(endpoint, {
        headers: this.headers
      })
